...
$(function() {
  ...
  // KBW-Countdown Start
  // --------------------------------------------- //
  $('#countdown').countdown({until: $.countdown.UTCDate(+1, 2023, 11, 27), format: 'D'});
  // --------------------------------------------- //
  // KBW-Countdown End
  // --------------------------------------------- //
  ...
  $('.notify-form').ajaxChimp({
    ...
    url: 'https://design.us13.list-manage.com/subscribe/post?u=d637430c0a9c20432b1190c7e&amp;id=aa55f24887&amp;f_id=0019f2e7f0'
  });
